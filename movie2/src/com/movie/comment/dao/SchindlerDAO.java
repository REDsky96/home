...
public class SchindlerDAO {
	...
	public List<NewCinemaParadiseDTO> getComment() throws SQLException {
	  ...
	  String sql = "select * from comments where id = 4 ORDER BY insert_date DESC";
	...
	public int insert(String name, String star, String comment) throws SQLException {
		...
		String sql = "insert into comments (name, star, comment, insert_date, id) value(?,?,?,?,'4')";
